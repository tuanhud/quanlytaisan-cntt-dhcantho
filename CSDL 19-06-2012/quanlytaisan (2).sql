...
--
-- Host: localhost
-- Generation Time: Jul 08, 2012 at 02:13 AM
...
INSERT INTO `loaikiemke` (`MaLoaiKK`, `TenLoaiKK`) VALUES
('1', 'Kiểm kê cố định'),
('2', 'Kiểm kê không cố định');
...
INSERT INTO `noidung` (`MaND`, `TenDonViTinh`, `TenND`, `GhiChuND`) VALUES
('1', 'Cái', 'Nhãn hiệu', 'sfasdgasdgsadgasd'),
('2', 'Cái', 'Module', 'makdfmasdfasdfasdf'),
('3', 'Cái', 'Thiết bị', 'dfsdfmafasdfadf'),
('4', 'Cái', 'Type', 'ànkadnfasdfasdf');
...
INSERT INTO `noidungcon` (`Noi_MaND`, `MaND`) VALUES
('2', '1'),
('3', '1'),
('3', '2'),
('2', '3');
...
CREATE TABLE IF NOT EXISTS `phieumau` (
  ...
  `NgayLap` varchar(2) default NULL,
  `ThangLap` varchar(2) NOT NULL,
  `NamLap` varchar(4) NOT NULL,
...
INSERT INTO `phieumau` (`MaPhieu`, `TenPhieu`, `GhiChuPhieu`, `NgayLap`, `ThangLap`, `NamLap`, `CapNhatMoiNhat`, `KhoaCapNhat`) VALUES
('2', 'Phiếu mẫu 2', 'Anh chinh ga lăng', '2', '2', '2012', '2012-07-07', 0);
...
CREATE TABLE IF NOT EXISTS `taisanduocthanhly` (
  ...
  KEY `FK_TaiSanDuocThanhLy2` (`MSDV`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `taisanduocthanhly` (`MaThanhLy`, `MSDV`, `MaTaiSan`, `SLThanhLy`) VALUES
('1', '1', '1', 88),
('2', '1', '1', 88),
('3', '1', '1', 50),
('4', '1', '2', 2);
...
INSERT INTO `thanhlytaisan` (`MaThanhLy`, `Nam`, `DienGiaiThanhLy`) VALUES
('1', '2012', 'fasdkfasdfafdaf'),
('2', '2012', 'fasdkfasdfafdaf'),
('3', '2012', 'hgjhg'),
('4', '2012', 'sdfsfgsdfgsdf');
...
INSERT INTO `thuocphieumau` (`MaPhieu`, `MaND`) VALUES
('2', '1'),
('2', '2');
