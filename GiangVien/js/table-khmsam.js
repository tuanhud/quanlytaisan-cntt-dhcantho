...
//        });*/
        ...
        $("#deleterowbutton").bind('click', function () 
		{
				...
				var data = "delete=true&MaTaiSan=" +mataisan; 					
				$.ajax
				({
					dataType: 'json',
		...
		$("#save").bind('click', function () 
		 {
					...
					for(var i=0;i < rowscount;i++) 
					{
							...
							{
								http=GetXmlHttpObject();
								var params = "insert=true&MaTaiSan=" + mats+"&SoLuong=" + 1+"&DonGia=" + dongia;				
		...
		$("#jqthem").bind('cellendedit', function (event) 
		{
		   ...
		   if(column=='SoLuong' )
		   {
			...
			{
				http=GetXmlHttpObject();
				var params = "SoLuong=" + sl + "&ThuyetMinh=" + value+ "&MaTaiSan=" + ma+ "&DonGia=" + dg;		
