              ...
              <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="70%" align="left" class="level_1_2"><input name="txt_donvi" id="txt_donvi" class="txtbox" style="width:100%" maxlength="6" onKeyPress="return keypress(event)"></td>
                  </tr>
                  <tr>
                    <td height="22" align="right" class="level_1_2">Mã số cán bộ</td>
                    <td width="70%" align="left" class="level_1_2"><input name="txt_masocanbo" id="txt_masocanbo" class="txtbox" style="width:100%" maxlength="6" onKeyPress="return keypress(event)"></td>
                  </tr>
                  <tr>
