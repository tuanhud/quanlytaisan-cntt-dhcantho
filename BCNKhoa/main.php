...
<title>Ban chấp hành Liên chi hội sinh viên</title>
      ...
      <table width="50%" height="280" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td style="font-family:Arial, Helvetica, sans-serif; font-size:12px">
                ...
                <tr>
                  <td width="20%" class="bordersv"><div class="bg" align="right">Mã HV</div></td>
                  <td width="55%" class="bordersv"><div class="bold" align="left"><?=$_SESSION['mslchsv']?></div></td>
                </tr>
                <tr>
                <? 
				...
				$user = new database();
				$sql = "Select * from hoivien where HOIVIEN_ID = '".$_SESSION['mslchsv']."'";
				$user->setQuery($sql);
                ...
                <tr>
                  ...
                  <?
				  //hien thi ten khoa
				  $sql = "Select * from hoivien, chuyennganh, khoa where hoivien.chuyennganh_id = chuyennganh.chuyennganh_id and chuyennganh.khoa_id = khoa.khoa_id and hoivien.hoivien_id = '".$_SESSION['mslchsv']."'";
				  $user->setQuery($sql);
                  $result = $user->fetchAll();
				  $row = mysql_fetch_array($result);
				  ?>
