...
<title>Trang BCH CHSV đăng nhập</title>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>
			  <div align="center"><strong class="headerlogin">Cán bộ QLBM đăng nhập </strong></div></td>
            </tr>
          </tbody></table>
		  </td>
        <td class="tr">&nbsp;</td>
          ...
          <tr>
            <td colspan="3">
              <div align="center">
                ...
                <input type="reset" name="btnLamLai" class="button_1" value="Nhập lại" title="">            
              </div></td>
            </tr>
        </tbody></table>
        </form></td>
