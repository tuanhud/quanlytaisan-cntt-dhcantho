...
<title>Tìm kiếm hội viên theo Ban của LCHSV, CHSV trong từng NHHK</title>
...
$(document).ready(function() { 
	fillcombo('./get_list_namhoc.php',document.frm_timkiemDSHV_B_LCHSV_CHSV_NHHK.cbo_tennamhoc);	
	fillcombo('./get_list_lchsv.php',document.frm_timkiemDSHV_B_LCHSV_CHSV_NHHK.cbo_tenlchsv);	
	fillcombo('./get_list_ban.php',document.frm_timkiemDSHV_B_LCHSV_CHSV_NHHK.cbo_tenban);	
	//su kien Chon Nam hoc
	$('form[name="frm_timkiemDSHV_B_LCHSV_CHSV_NHHK"] select[name="cbo_tennamhoc"]').change(function(){
//		get_DSHV_NH('./get_DSHV_NH.php',document.frm_timkiemDSHV_LCHSV_CHSV_NHHK);
		_fillcombo('./get_list_hocki.php',document.frm_timkiemDSHV_B_LCHSV_CHSV_NHHK.cbo_tennamhoc, document.frm_timkiemDSHV_B_LCHSV_CHSV_NHHK.cbo_tenhocki);
	});
	//su kien Chon Hoc ki
	$('form[name="frm_timkiemDSHV_B_LCHSV_CHSV_NHHK"] select[name="cbo_tenhocki"]').change(function(){
//		get_DSHV_HK('./get_DSHV_HK.php',document.frm_timkiemDSHV_LCHSV_CHSV_NHHK);
	});
	//su kien chon LCHSV
	$('form[name="frm_timkiemDSHV_B_LCHSV_CHSV_NHHK"] select[name="cbo_tenlchsv"]').change(function(){
//		get_DSHV_LCHSV('./get_DSHV_LCHSV.php',document.frm_timkiemDSHV_LCHSV_CHSV_NHHK);
		_fillcombo('./get_list_chsv.php',document.frm_timkiemDSHV_B_LCHSV_CHSV_NHHK.cbo_tenlchsv, document.frm_timkiemDSHV_B_LCHSV_CHSV_NHHK.cbo_tenchsv);
	});
	//su kien chon CHSV
	$('form[name="frm_timkiemDSHV_B_LCHSV_CHSV_NHHK"] select[name="cbo_tenchsv"]').change(function(){
  ...
  <tr>
    ...
    <td height="100%" align="center" valign="middle">   		 
        ...
        <tr class="main_1">
          ...
          <td width="80%" align="center">Tìm kiếm hội viên theo Ban của LCHSV, CHSV</td>
          <td width="180" align="right"> <img height="25" src="./images/giaodienchung/tbl_right.gif" width="10" border="0"></td>
        </tr>
        <tr>
          <td colspan="3" align="left">
          	<form name="frm_timkiemDSHV_B_LCHSV_CHSV_NHHK">
            <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">             		
             ...
             <tr>
					<td height="22" width="123" align="right" class="level_1_1">Chọn Năm học</td>
					<td width="246" align="left" class="level_1_1">
            ...
            <tr>
					<td height="22" align="right" class="level_1_1">Chọn Ban</td>
					<td align="left" class="level_1_1" colspan="3">
                    	<select name="cbo_tenban" class="cbo" style="width:40%;">                      
                        </select>                       
                    </td>
			</tr>  
                 <tr>					
