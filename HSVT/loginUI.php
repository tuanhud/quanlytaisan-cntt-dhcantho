...
<title>Trang BCH Hội sinh viên trường đăng nhập</title>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>
			  <div align="center"><strong class="headerlogin">BCH Hội sinh viên Trường</strong></div></td>
            </tr>
          </tbody></table>
		  </td>
        <td class="tr">&nbsp;</td>
      ...
      <tbody><tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="30%" class="textlogin" align="right">Mã số:&nbsp;</td>
