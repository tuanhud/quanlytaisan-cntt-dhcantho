...
<title>Cập nhật khen thưởng</title>
...
<script type="text/javascript" src="./js/khenthuong.js"></script>
<script type="text/javascript" src="./js/fill.js"></script>
<script type="text/javascript" >
$(document).ready(function() { 
	fillcombo('./get_list_namhoc.php',document.frm_capnhatkhenthuong.cbo_tennamhoc);
	get_cur_namhoc('./get_cur_namhoc.php',document.frm_capnhatkhenthuong);
	_fillcombo('./get_list_hocki.php',document.frm_capnhatkhenthuong.cbo_tennamhoc, document.frm_capnhatkhenthuong.cbo_tenhocki);
	get_cur_hocki('./get_cur_hocki.php',document.frm_capnhatkhenthuong);
	fillcombo('./get_list_lchsv.php',document.frm_capnhatkhenthuong.cbo_tenlchsv);	
	fillcombo('./get_list_khenthuong.php',document.frm_capnhatkhenthuong.cbo_tenkhenthuong);
		init_date_input(document.frm_capnhatkhenthuong.cbo_ngay,document.frm_capnhatkhenthuong.cbo_thang,document.frm_capnhatkhenthuong.cbo_nam);	


	//su kien chon LCHSV
	$('form[name="frm_capnhatkhenthuong"] select[name="cbo_tenlchsv"]').change(function(){		
		_fillcombo('./get_list_chsv.php',document.frm_capnhatkhenthuong.cbo_tenlchsv, document.frm_capnhatkhenthuong.cbo_tenchsv);
	});
	//su kien chon CHSV
	$('form[name="frm_capnhatkhenthuong"] select[name="cbo_tenchsv"]').change(function(){		
		autoComplete('./get_list_hoivien1.php',document.frm_capnhatkhenthuong);
	});		
}); 
</script>
</head>
  ...
  <tr>
    ...
    <td height="100%" align="center" valign="middle">   		 
        ...
        <tr class="main_1">
          ...
          <td width="80%" align="center">Cập nhật khen thưởng</td>
          <td width="180" align="right"> <img height="25" src="./images/giaodienchung/tbl_right.gif" width="10" border="0"></td>
        </tr>
        <tr>
          <td colspan="3" align="left">
          	<form name="frm_capnhatkhenthuong">
            <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">             		
             ...
             <tr>
					...
					<td width="259" align="left" class="level_1_1">
                    	<select name="cbo_tenhocki" class="cbo" style="width:90%;" disabled>                      
                        </select>                       
                    </td>
			</tr>
            ...
            <tr>
					...
					<td align="left" class="level_1_1">
                    	<select name="cbo_tenkhenthuong" class="cbo" style="width:87%;">                      
                        </select> 
                        <input type="button" id= "openButton" name="btnThemHTKT" value="+">
<div id="panelContent">
    ...
    <div class="yui3-widget-bd" align="center">
        ...
        <td><input type="text" id="txt_tenHTKT" name="txt_tenkhenthuong" style="width:100%"></td>
        </tr>
        <tr>
        ...
        <td><textarea cols="15" rows="3" name="txta_ghichu" id="txt_ghichu" style="width:100%"></textarea></td>
            ...
            <td align="left" class="level_1_1" colspan="3">
                        ...
                        <input type="button" name="btnImport" id="btnImport" class="button_1" value="Import">
                    </td>
            </tr>
                 <tr>
        ...
        buttons: [
            {
                ...
                section: 'footer',
                action : function (e) {
						themKhenthuong('themkhenthuong.php',frm_capnhatkhenthuong);						
						fillcombo('./get_list_khenthuong.php',document.frm_capnhatkhenthuong.cbo_tenkhenthuong);							                    
                }
            },
			{
