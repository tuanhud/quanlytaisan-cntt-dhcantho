...
//		/* Lưu dữ liệu vào DB
//		/*---------------------------------------------*/
//		$sql = "INSERT INTO `qlhsv`.`hoivien_khenthuong` (`CAPHOI_ID`, `HOCKI_ID`, `KHENTHUONG_ID`, `HOIVIEN_ID`,`KHENTHUONG_THOIGIAN`, `KHENTHUONG_QUYETDINH`, `KHENTHUONG_DONVI`) VALUES(1, '".$_POST['cbo_tenhocki']."', '".$_POST['cbo_tenkhenthuong']."', '".$data->val($i,3)."','".date( 'y-m-d', strtotime($_POST['cbo_thang']."/".$_POST['cbo_ngay']."/".$_POST['cbo_nam']))."','".$_POST['txt_quyetdinh']."', 0)";
//		
//		$db->setQuery($sql);		
//		$result=$db->fetchAll();
//		if($result)
