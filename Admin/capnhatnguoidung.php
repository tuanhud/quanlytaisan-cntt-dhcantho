        ...
        <tr>
          <td colspan="3" align="left">
            ...
            <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">             		
              ...
              <tr>
					<td height="22" align="right" class="level_1_2">Chọn bộ môn</td>
              ...
              <tr>
					...
					Nữ<input name="gioitinh" class="txtbox" type="radio"  value="0">					
					</td>
			  </tr>
			  <tr>
        ...
        <tr>
          <td colspan="3" align="left">
            ...
            <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">             		
              ...
              <tr>
              		<td colspan="2" height="22" align="center" class="level_1_1"><input type="button" class="button_1" value="Sửa" ></td>
              </tr>
              </tbody>
           </table>
           </form>
