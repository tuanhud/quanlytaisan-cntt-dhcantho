...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	$('form[name="frm_duyetphieudutruvpp"] select[name="cbo_quyduyet"]').change(function(){
		fillcombo3bien('get_list_maphieudutruvpp_report.php',document.frm_duyetphieudutruvpp.cbo_donviduyet,document.frm_duyetphieudutruvpp.cbo_namduyet,document.frm_duyetphieudutruvpp.cbo_quyduyet, document.frm_duyetphieudutruvpp.cbo_maphieuduyet);
	});
