    ...
    <td height="100%" align="center" valign="middle">   
        ...
        <tr>
          <td colspan="3" align="left">
            ...
            <tr>
					<td height="30" align="right" class="level_1_1">Năm áp dụng</td>
             ...
             <tr>
					...
					<td width="50%" align="left" class="level_1_2"><input name="txt_tenthietbi" type="text" disabled class="txtbox" style="width:100%" onKeyPress="return keypress(event)" value="" maxlength="31"></td>
			</tr>
             <tr>
					<td height="22" align="right" class="level_1_1">Phiếu dự toán của đơn vị</td>
					<td width="50%" align="left" class="level_1_1"><input name="txt_tenthietbi" type="text" disabled class="txtbox" style="width:100%" onKeyPress="return keypress(event)" value="" maxlength="31"></td>
			</tr>               
              <tr>
          ...
          <td colspan="3" align="left">
            ...
            <tr>
              <td colspan="2" height="22" align="center" class="level_1_1">
                <input type="button" class="button_1" value="Bỏ duyệt">
                </td>
            </tr>
