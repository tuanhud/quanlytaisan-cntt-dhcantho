...
//}
//
//function insertHTMLCode(stack, tag, attributes) {
//	var post_form = get_post_form();
//	el = post_form;
//        var selectedText = '';
...
//	}       
//        var formattedText = formatCode(selectedText);
//        if (el.setSelectionRange) {
//		selectedText = el.value.substring(el.selectionStart,el.selectionEnd);
//		if (selectedText == "") { return false; }
//		el.value = el.value.substring(0,el.selectionStart) + formattedText + el.value.substring(el.selectionEnd,el.value.length);
//		return true;
//	}
//	else {
...
//        linecount++;
//    }
//    return "<pre style='max-width: 740px; width: 740px; margin: 5px; padding: 5px;' class='code'>" + newcode + "</pre>";
//}
//
