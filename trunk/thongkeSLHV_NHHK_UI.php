...
<title>Thống kê số lượng hội viên theo LCHSV trong từng NHHK</title>
...
$(document).ready(function() { 
	fillcombo('./get_list_namhoc.php',document.frm_thongkeSLHV_NHHK.cbo_tennamhoc);
	fillcombo('./get_list_lchsv.php',document.frm_thongkeSLHV_NHHK.cbo_tenlchsv);

	//su kien Chon Nam hoc
	$('form[name="frm_thongkeSLHV_NHHK"] select[name="cbo_tennamhoc"]').change(function(){
			_fillcombo('./get_list_hocki.php',document.frm_thongkeSLHV_NHHK.cbo_tennamhoc, document.frm_thongkeSLHV_NHHK.cbo_tenhocki);
			SLHV_NHHK('./thongkeSLHV_NHHK.php',document.frm_thongkeSLHV_NHHK.cbo_tennamhoc.value, document.frm_thongkeSLHV_NHHK.cbo_tenhocki.value);
	});	
	//Su kien chon hoc ki
	$('form[name="frm_thongkeSLHV_NHHK"] select[name="cbo_tenhocki"]').change(function(){	
			SLHV_NHHK('./thongkeSLHV_NHHK.php',document.frm_thongkeSLHV_NHHK.cbo_tennamhoc.value, document.frm_thongkeSLHV_NHHK.cbo_tenhocki.value);
	});	
	//su kien Chon LCHSV
	$('form[name="frm_thongkeSLHV_NHHK"] select[name="cbo_tenlchsv"]').change(function(){
			SLHV_NHHK_LCHSV('./thongkeSLHV_NHHK_LCHSV.php',document.frm_thongkeSLHV_NHHK.cbo_tennamhoc.value,document.frm_thongkeSLHV_NHHK.cbo_tenhocki.value,document.frm_thongkeSLHV_NHHK.cbo_tenlchsv.value);
	});	
	
	//Su kien check
/*	$('form[name="frm_thongkeSLHV_NHHK"] input[name="chk_lchsv"]').click(function(){
	if($('input[name=chk_lchsv]').is(':checked')){
		$('form[name="frm_thongkeSLHV_NHHK"] select[name="cbo_tenlchsv"]').removeAttr('disabled');
		}
	else
	{	
	$('form[name="frm_thongkeSLHV_NHHK"] select[name="cbo_tenlchsv"]').attr('disabled', 'disabled');
		}
	});*/
}); 
</script>
  ...
  <tr>
    ...
    <td height="100%" valign="middle">   		 
        ...
        <tr class="main_1">
          ...
          <td width="500" align="center">Số lượng hội viên của các LCHSV theo từng NHHK</td>
          <td width="180" align="right"> <img height="25" src="./images/giaodienchung/tbl_right.gif" width="10" border="0"></td>
        </tr>
        <tr>
          <td colspan="3" align="left">
          	<form name="frm_thongkeSLHV_NHHK" action="baocao_SLHV_NHHK_UI.php" method="post" target="export" onSubmit="window.open('', 'export', 'width=1350,height=660,status=yes,resizable=yes,scrollbars=yes')">
            <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">             		
             ...
             <tr>
					<td height="22" width="17%" align="right" class="level_1_1">Chọn Năm học</td>
            ...
            <tr>
					...
					<td align="left" colspan="3" class="level_1_1">
                    	<select name="cbo_tenlchsv" class="cbo" style="width:42%;">                      
                        </select>                       
                    </td>
			</tr>
            <tr>					
					<td align="center" class="level_1_1" colspan="4">
