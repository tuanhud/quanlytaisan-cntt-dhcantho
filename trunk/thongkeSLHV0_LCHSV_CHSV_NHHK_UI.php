...
<title>Thống kê số lượng hội viên không còn tham gia theo LCHSV, CHSV của từng NHHK</title>
...
$(document).ready(function() { 
	fillcombo('./get_list_namhoc.php',document.frm_thongkeSLHV0_LCHSV_CHSV_NHHK.cbo_tennamhoc);
	fillcombo('./get_list_lchsv.php',document.frm_thongkeSLHV0_LCHSV_CHSV_NHHK.cbo_tenlchsv);

	//su kien Chon Nam hoc
	$('form[name="frm_thongkeSLHV0_LCHSV_CHSV_NHHK"] select[name="cbo_tennamhoc"]').change(function(){
			_fillcombo('./get_list_hocki.php',document.frm_thongkeSLHV0_LCHSV_CHSV_NHHK.cbo_tennamhoc, document.frm_thongkeSLHV0_LCHSV_CHSV_NHHK.cbo_tenhocki);
	});	
	//su kien Chon LCHSV
	$('form[name="frm_thongkeSLHV0_LCHSV_CHSV_NHHK"] select[name="cbo_tenlchsv"]').change(function(){
			_fillcombo('./get_list_chsv.php',document.frm_thongkeSLHV0_LCHSV_CHSV_NHHK.cbo_tenlchsv, document.frm_thongkeSLHV0_LCHSV_CHSV_NHHK.cbo_tenchsv);
	});	
}); 
</script>
</head>
    ...
    <td height="100%" align="center" valign="middle">   		 
        ...
        <tr>
          <td colspan="3" align="left">
          	<form name="frm_thongkeSLHV0_LCHSV_CHSV_NHHK">
