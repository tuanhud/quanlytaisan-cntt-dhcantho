...
$(document).ready(function() { 
	fillcombo('./get_list_namhoc.php',document.frm_thongkeSLHV_hoatdong_NHHK.cbo_tennamhoc);
	fillcombo('./get_list_hoatdong.php',document.frm_thongkeSLHV_hoatdong_NHHK.cbo_tenhoatdong);

	//su kien Chon Nam hoc
	$('form[name="frm_thongkeSLHV_hoatdong_NHHK"] select[name="cbo_tennamhoc"]').change(function(){
			_fillcombo('./get_list_hocki.php',document.frm_thongkeSLHV_hoatdong_NHHK.cbo_tennamhoc, document.frm_thongkeSLHV_hoatdong_NHHK.cbo_tenhocki);
	});	
    ...
    <td height="100%" align="center" valign="middle">   		 
        ...
        <tr>
          <td colspan="3" align="left">
          	<form name="frm_thongkeSLHV_hoatdong_NHHK">
            ...
            <tr>
					...
					<td align="left" colspan="3" class="level_1_1">
                    	<select name="cbo_tenhoatdong" class="cbo" style="width:80%;">                      
                        </select>                       
                    </td>                    
			</tr>
                 <tr>
