...
{
	return new SkypeClick2Call.ChangeSink(doc);
}
 ...
 * @param  doc  Parent document.
 */
SkypeClick2Call.ChangeSink = function(doc)
{
...
SkypeClick2Call.ChangeSink.prototype.EventHandler = function(event)
{
	try
	{
		...
		if (this.m_injection)
		{
			...
			if (compare & SkypeClick2Call.Node.DOCUMENT_POSITION_CONTAINED_BY)
			{
		...
		if (this.m_modifiedNodes.length > 0)
		{
			...
			if (compare & SkypeClick2Call.Node.DOCUMENT_POSITION_CONTAINS)
			{
			...
			if (compare & SkypeClick2Call.Node.DOCUMENT_POSITION_FOLLOWING)
			{
			...
			if (compare & SkypeClick2Call.Node.DOCUMENT_POSITION_PRECEDING)
			{
