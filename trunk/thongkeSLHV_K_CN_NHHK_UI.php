...
<title>Thống kê số lượng hội viên theo Khoa - Chuyên ngành của từng NHHK</title>
...
$(document).ready(function() { 
	fillcombo('./get_list_namhoc.php',document.frm_thongkeSLHV_K_CN_NHHK.cbo_tennamhoc);
	fillcombo('./get_list_khoa.php',document.frm_thongkeSLHV_K_CN_NHHK.cbo_tenkhoa);

	//su kien Chon Nam hoc
	$('form[name="frm_thongkeSLHV_K_CN_NHHK"] select[name="cbo_tennamhoc"]').change(function(){
			_fillcombo('./get_list_hocki.php',document.frm_thongkeSLHV_K_CN_NHHK.cbo_tennamhoc, document.frm_thongkeSLHV_K_CN_NHHK.cbo_tenhocki);
	});	
	//su kien Chon LCHSV
	$('form[name="frm_thongkeSLHV_K_CN_NHHK"] select[name="cbo_tenkhoa"]').change(function(){
			_fillcombo('./get_list_chuyennganh.php',document.frm_thongkeSLHV_K_CN_NHHK.cbo_tenkhoa, document.frm_thongkeSLHV_K_CN_NHHK.cbo_tenchuyennganh);
	});	
}); 
</script>
</head>
  ...
  <tr>
    ...
    <td height="100%" align="center" valign="middle">   		 
        ...
        <tr class="main_1">
          ...
          <td width="500" align="center">Thống kê số lượng hội viên theo từng LCHSV - CHSV</td>
          <td width="180" align="right"> <img height="25" src="./images/giaodienchung/tbl_right.gif" width="10" border="0"></td>
        </tr>
        <tr>
          <td colspan="3" align="left">
          	<form name="frm_thongkeSLHV_K_CN_NHHK">
            ...
            <tr>
					...
					<td align="left" class="level_1_1">
                    	<select name="cbo_tenkhoa" class="cbo" style="width:90%;">                      
                        </select>                       
                    </td>
                    <td height="22" align="right" class="level_1_1">Chọn Chuyên ngành</td>
					<td align="left" class="level_1_1">
                    	<select name="cbo_tenchuyennganh" class="cbo" style="width:90%;">                      
                        </select>                       
                    </td>
			</tr>
                 <tr>
