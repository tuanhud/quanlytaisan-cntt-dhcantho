        ...
        <tr>
          <td colspan="3" align="left">
            ...
            <tr>
					...
					<td width="50%" align="left" class="level_1_2"><textarea name="txt_tenthietbi" rows="3" class="txtbox" style="width:100%" onKeyPress="return keypress(event)"></textarea></td>
			</tr>               
              <tr>
        ...
        <tr>
          <td colspan="3" align="left">
            ...
            <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">             		
             ...
             <tr>
					<td height="22" align="right" class="level_1_1">Chọn mã loại văn phòng phẩm</td>
            ...
            <tr>
					...
					<td width="50%" align="left" class="level_1_1"><textarea name="txt_tenloaithietbi" rows="3" class="txtbox" style="width:100%" onKeyPress="return keypress(event)"></textarea>
					</td>
			</tr> 
            <tr>
        ...
        <tr>
          <td colspan="3" align="left">
            ...
            <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">             		
             ...
             <tr>
					<td height="22" align="right" class="level_1_2">Chọn mã loại văn phòng phẩm cần xóa</td>
					<td width="50%" align="left" class="level_1_1">
                    	<select name="cbo_tenloaithietbi" class="cbo" style="width:100%;">
                        </select>                       
                    </td>
            ...
            <tr>
					...
					<td width="50%" align="left" class="level_1_1"><input name="xoa_tennsx" type="text" disabled class="txtbox"style="width:100%" onKeyPress="return keypress(event)" value="" maxlength="31"></td>
			</tr> 
             <tr>
					<td height="22" align="right" class="level_1_2">Diễn giải loại văn phòng phẩm cần xóa</td>
					<td width="50%" align="left" class="level_1_2"><textarea name="xoa_tennsx" rows="3" disabled class="txtbox" style="width:100%" onKeyPress="return keypress(event)"></textarea></td>
			</tr>
             <tr>
