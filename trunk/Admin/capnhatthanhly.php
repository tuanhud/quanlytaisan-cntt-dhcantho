	...
	<td height="54%" valign="middle">
      ...
      <td align="center" width="100%"><table width="500" border="0" cellpadding="0" cellspacing="0">
        <tbody>
          <tr class="main_1">
            ...
            <td width="419" align="center">Thêm tài sản thanh lý</td>
              ...
              <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="50%" align="left" class="level_1_2"><select name="cbotentstl" class="cbo" style="width:100%;">
                    </select></td>
                  <tr>
                  ...
                  <tr>
                    <td height="22" align="right" class="level_1_1">Số lượng thanh lý:</td>
                    <td width="50%" align="left" class="level_1_1"><input name="txtsltstl" maxlength="31" type="text" class="txtbox" style="width:100%" value="" onKeyPress="return keypress(event)"></td>
                  </tr>
                  <tr>
                    <td height="22" align="right" class="level_1_1">Năm thanh lý:</td>
                    <td width="50%" align="left" class="level_1_1"><label for="cbonamtlts"></label>
                      <select name="cbonamtlts" id="cbonamtlts" style="width:30%">
                      </select></td>
                  </tr>
                  <tr>
      ...
      <table width="500" border="0" cellpadding="0" cellspacing="0">
        <tbody>
          <tr class="main_1">
            <td width="161" align="left"><img height="25" src="../images/giaodienchung/tbl_left.gif" width="10" border="0"></td>
            <td width="419" align="center">Sửa tài sản thanh lý</td>
            <td width="180" align="right"><img height="25" src="../images/giaodienchung/tbl_right.gif" width="10" border="0"></td>
          </tr>
          <tr>
            <td colspan="3" align="left"><form name="frm_themban">
              <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">
                <tbody>
                  ...
                  <tr>
                    <td height="22" align="right" class="level_1_2">Chọn tài sản cần sửa:</td>
                    <td width="50%" align="left" class="level_1_2"><select name="cbotentstl" class="cbo" style="width:100%;">
                    </select></td>
                  <tr>
                    <td height="22" align="right" class="level_1_2">Mã tài sản:</td>
      ...
      <table width="500" border="0" cellpadding="0" cellspacing="0">
        <tbody>
          <tr class="main_1">
            <td width="161" align="left"><img height="25" src="../images/giaodienchung/tbl_left.gif" width="10" border="0"></td>
            <td width="419" align="center">Xóa tài sản thanh lý</td>
            <td width="180" align="right"><img height="25" src="../images/giaodienchung/tbl_right.gif" width="10" border="0"></td>
          </tr>
          <tr>
            <td colspan="3" align="left"><form name="frm_themban">
              <table width="100%" class="border_1" bordercolor="#111111" cellspacing="0" cellpadding="0" align="center" border="0">
                <tbody>
                  ...
                  <tr>
                    <td height="22" align="right" class="level_1_2">Chọn tài sản cần xóa:</td>
                    <td width="50%" align="left" class="level_1_2"><select name="cbotentstl" class="cbo" style="width:100%;">
                    </select></td>
                  <tr>
                    <td height="22" align="right" class="level_1_2">Mã tài sản:</td>
                  ...
                  <tr>
                    <td height="22" align="right" class="level_1_1">Số lượng thanh lý:</td>
                    <td width="50%" align="left" class="level_1_1"><input name="txtsltstl" type="text" disabled class="txtbox" style="width:100%" onKeyPress="return keypress(event)" value="" maxlength="31" readonly="readonly"></td>
                  </tr>
                  <tr>
                    <td height="22" align="right" class="level_1_1">Năm thanh lý:</td>
                    <td width="50%" align="left" class="level_1_1"><label for="cbonamtlts"></label>
