              ...
              <tr>
               ...
               <tr>
					...
					<td width="50%" align="left" class="level_1_2">
                    	<input name="txt_tenloaivppthem" id="txt_tenloaivppthem" type="text" class="txtbox" style="width:99%"></td>
			</tr>     
            <tr>
					<td height="22" align="right" class="level_1_2">Diễn giải loại văn phòng phẩm</td>
					<td width="50%" align="left" class="level_1_2"><textarea name="txt_diengiailoaivppthem" id="txt_diengiailoaivppthem" rows="3" class="txtbox" style="width:99%"></textarea></td>
			</tr>               
              <tr>
        ...
        <tr>
          <td colspan="3" align="left">
            ...
            <tr>
					...
					<td width="50%" align="left" class="level_1_1">
                    	<input name="txt_tenloaivppsua" id="txt_tenloaivppsua" type="text" class="txtbox" style="width:99%">
					</td>
			</tr> 
            <tr>
					<td height="22" align="right" class="level_1_1">Diễn giải loại văn phòng phẩm mới</td>
					<td width="50%" align="left" class="level_1_1"><textarea name="txt_diengiailoaivppsua" id="txt_diengiailoaivppsua" rows="3" class="txtbox" style="width:99%"></textarea>
					</td>
			</tr> 
            <tr>
        ...
        <tr>
          <td colspan="3" align="left">
            ...
            <tr>
					...
					<td width="50%" align="left" class="level_1_1"><input name="txt_tenloaivppxoa" id="txt_tenloaivppxoa" type="text" disabled class="txtbox"style="width:99%"></td>
			</tr> 
             <tr>
					<td height="22" align="right" class="level_1_2">Diễn giải loại văn phòng phẩm cần xóa</td>
					<td width="50%" align="left" class="level_1_2"><textarea name="txt_diengiailoaivppxoa" id="txt_diengiailoaivppxoa" rows="3" disabled class="txtbox" style="width:99%"></textarea></td>
			</tr>
             <tr>
